...
\begin{itemize}[label=\textbullet]
	...
	\begin{description}
		\item \textit{description :} exécuter du code Lua sur le PcDuino
		\item \textit{priorité :} très haute
		\item \textit{justification :} cette fonctionnalité est la principale. Nous devons être en mesure de faire fonctionner le robot grâce à du code Lua avant toute autre chose.
